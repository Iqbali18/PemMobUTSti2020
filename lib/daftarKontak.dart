...
class _ListKontakPageState extends State<ListKontakPage> {
    ...
    return Scaffold(
      ...
      body: ListView.builder(
          ...
          itemBuilder: (context, index) {
            KontakApp kontak = listKontak[index];
            return Padding(
                ...
                subtitle: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text('${kontak.mobileNo}',style: TextStyle(
                        fontSize: 20,
                            ...
                            actions: [
                              TextButton(
                                ...
                                child: Text(
                                  "Iya",
                                  style: TextStyle(
                                    color:  Color.fromARGB(255, 179, 6, 29),
                                  ),
                                ),
                              ),
                              TextButton(
  ...
  Future<void> _getAllKontak() async {
    ...
    setState(() {
      ...
      list!.forEach((kontak) {
        ...
        listKontak.add(KontakApp.fromMap(kontak));
      });
    });
  }

  //menghapus data Kontak
  Future<void> _deleteKontak(KontakApp kontak, int position) async {
  ...
  Future<void> _openFormEdit(KontakApp kontak) async {
